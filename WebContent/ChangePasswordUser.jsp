 ...
 <div id="logout"><font face="verdana" color="Cyan" size=3><a href="LogoutServlet">Logout</a></font></div>
      ...
      <div id="menu"><table><tr><td>
       <font color="#3C3504" size="6">	HALDIA </font></td><td> <font color="#3C3504" size="6"> INSTITUTE</font></td><td> <font color="#3C3504" size="6">   OF  </font></td><td><font color="#3C3504" size="6">  TECHNOLOGY</font></td></tr></table>
        ...
        <br>
   <form action="ChangePasswordServletUser" method="post" onsubmit="return check()" name="change_password">

<table>
<tr><td colspan=2 ><font face="tahoma" size="5"><u>Change Password :<%=session.getAttribute("userEmail") %></u></font></td></tr>
</table><br>
<table>
...
<font face="verdana" color="blue" size=3>Go To <a href="userHomePage.jsp">User Home </a></font>
</body>
</html>