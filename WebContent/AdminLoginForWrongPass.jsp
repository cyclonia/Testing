...
<br>
<table>
<tr><td><button type="submit" name="submit" class="post">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>LOGIN</b></button></td><td><button type="button" name="cancel" onclick="window.location.href='\HomePage.html'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>CANCEL</b></button></td><td><button type="reset">RESET</button></td></tr>
