...
<br><form action="ShowIndividualDetailsToAdmin" method="get">

<table>
<tr><td><b><font face="Verdana">Student Registration No. : </font></b></td><td><input type="text" name="student_registration_no" required="required"></td></tr>
</table>
<br>
<table>
