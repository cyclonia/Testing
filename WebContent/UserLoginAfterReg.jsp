...
<div id="container">
		...
		<font face="verdana" color="green" size=5>Hi !<b><u><%=request.getAttribute("regUser") %></u></b>,Now You can Login with your email and password</font>
		<font face="verdana" color="green" size=5><br>Your Registration Number is :<b><%=request.getAttribute("regNumber") %></b></font>
		</div>
