...
<div id="content">
<table>
<tr><td ><font  face="verdana" color="green" size="5">Thanks For Participating <b><i><%= session.getAttribute("userEmail") %></i></b></font></td></tr>
<tr><td><font  face="verdana" color="green" size="5">Your score is : <b><%=(Integer)request.getAttribute("score") %></b></font></td></tr>

</table><br><br><br>
<font face="verdana" color="purple" size=5>Now you can <a href="LogoutServlet">Logout</a></font>
</div>
</body>
</html>