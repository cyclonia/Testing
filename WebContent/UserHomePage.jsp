...
<div id="content">
<font color="green" size="5">Welcome <b><%=request.getAttribute("userName") %></b></font><br><br>
...
<table>
<tr><td >
		<form action="ViewUserProfileServlet" method="get">
		<%request.setAttribute("email", userEmail); %>
		<button type="submit"><b>View Profile</b></button>
		</form>
	</td>
		
	<td>
	
	<form action="InstructionPage.jsp" method="get">
		<%request.setAttribute("email", userEmail); %>
		<button type="submit"><b>Go for Test</b></button>
		</form>
	
	</td>
	<td>

	<form action="ViewUserScoreServlet" method="get">
		<%request.setAttribute("email", userEmail); %>
		<button type="submit"><b>See Score</b></button>
		</form>
	
	</td>
	<!-- <td><a href="ChangePasswordUser.jsp">Change</a> -->
	<td>
	<form action="ChangePasswordUser.jsp" method="get">
	
		<button type="submit">Change Passwrd</button>
		</form>
		</td>
...
<br><br>
<font color="green" size="5"> <a href="HomePage.html">Go Back </a></font><br><br>
</body>
</html>